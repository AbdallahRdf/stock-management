        ...
        <form id="form" class="form" action="../../../controllers/ProductController.php" method="POST">
            ...
            <div class="inside-form-container">
                ...
                <div class="input-group">
                    ...
                    <input class="form-input" id="name" type="text" name="name" placeholder="Product Name"
                        value="<?= $old_name ?>">
                    <small>
                        <?= $name_error_message ?>
                    </small>
                ...
                <div class="input-group">
                    ...
                    <textarea name="description" id="description" class="form-input" cols="30" rows="5"
                        placeholder="Product Description"><?= $old_email ?></textarea>
                    <small>
                        <?= $email_error_message ?>
                    </small>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input id="pprice" class="form-input" type="text" name="purchase_price"
                        placeholder="Product Purchase Price" value="<?= $old_p_price ?>">
                    <small>
                ...
                <div class="input-group">
                    ...
                    <input id="s_price" class="form-input" type="text" name="selling_price"
                        placeholder="Product Selling Price" value="<?= $old_s_price ?>">
                    <small>
                ...
                <div class="input-group">
                    ...
                    <input class="form-input" id="quantity" type="number" min="0" name="quantity"
                        placeholder="Product Quantity" value="<?= $old_date ?>">
                    <small>
                        <?= $date_error_message ?>
                    </small>
                </div>
