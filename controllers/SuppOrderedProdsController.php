...
function goback()
{
    ...
    header("Location: ../resources/views/pages/.php");
    die();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST["ordered_p_id"] == "") { //create an ordered product
        ...
        $order_id = $_SESSION["SupplierOrderId"];
    ...
    } else if (isset($_POST["quantity"]) && $_POST["supplierOrdered_p_id"] != "") // updating an SupplierOrdered product
    {
        ...
        $quantity = $_POST["quantity"];
        //dd(['quantity' => $quantity, 'supplierOrdered_p_id' => $SupplierOrder_p_id, "product_id" => $product]);
