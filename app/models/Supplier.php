...
class Supplier
{
    ...
    {
        $sql = "SELECT id, full_name, email, phone_num, registration_date FROM suppliers ORDER BY created_at DESC;";
    ...
    {
        $sql = "SELECT id, full_name, email, phone_num, registration_date FROM suppliers ORDER BY created_at DESC LIMIT {$limit} OFFSET {$offset};";
